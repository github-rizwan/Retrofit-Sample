...
import in.rittz.retrofitsample.Adapter.TextListViewAdapter;
...
public class ShowEntryActivity extends AppCompatActivity {
    ...
    public void init()
    {
        ...
        adapter = new TextListViewAdapter(this,AllProducts);
    ...
    {
        Call<List<Product>> call = apiInterface.GetProductList();
